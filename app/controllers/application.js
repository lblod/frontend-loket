...
export default Controller.extend({
  ...
  isSupervision: equal('router.currentRouteName', 'supervision.submissions.index'),
  isSupervisionSubmission: equal('router.currentRouteName', 'supervision.submissions.edit'),
