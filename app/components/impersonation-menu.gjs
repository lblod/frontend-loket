...
const PlayIcon = <template>
  ...
  ><path
      fill-rule="evenodd"
      d="M19.985 11.741 5 20.482V3l14.985 8.741Zm-3.97 0L7 6.482V17l9.015-5.259Z"
      clip-rule="evenodd"
    /></svg>
</template>;
...
const PauseIcon = <template>
  ...
  ><path
      fill-rule="evenodd"
      d="M7 3h2c1.103 0 2 .896 2 2v14c0 1.103-.897 2-2 2H7c-1.103 0-2-.897-2-2V5c0-1.104.897-2 2-2Zm0 2v14h2.001L9 5H7Zm10-2h-2c-1.103 0-2 .896-2 2v14c0 1.103.897 2 2 2h2c1.103 0 2-.897 2-2V5c0-1.104-.897-2-2-2Zm-2 2v14h2.001L17 5h-2Z"
      clip-rule="evenodd"
    /></svg>
</template>;
